...
if (false) {(function () {  module.hot.accept()
  ...
  var id = "C:\\Users\\Aaron\\Desktop\\portfolio github\\portfolio\\public\\assets\\views\\About.vue"
  if (!module.hot.data) {
...
if (false) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "C:\\Users\\Aaron\\Desktop\\portfolio github\\portfolio\\public\\assets\\views\\App.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, __vue_template__)
...
if (false) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "C:\\Users\\Aaron\\Desktop\\portfolio github\\portfolio\\public\\assets\\views\\Contact.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, __vue_template__)
...
if (false) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "C:\\Users\\Aaron\\Desktop\\portfolio github\\portfolio\\public\\assets\\views\\Home.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, __vue_template__)
...
if (false) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "C:\\Users\\Aaron\\Desktop\\portfolio github\\portfolio\\public\\assets\\views\\Project.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, __vue_template__)
...
if (false) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "C:\\Users\\Aaron\\Desktop\\portfolio github\\portfolio\\public\\assets\\views\\projects\\360marine.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, __vue_template__)
...
if (false) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "C:\\Users\\Aaron\\Desktop\\portfolio github\\portfolio\\public\\assets\\views\\projects\\bearandmeerkat.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, __vue_template__)
...
if (false) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "C:\\Users\\Aaron\\Desktop\\portfolio github\\portfolio\\public\\assets\\views\\projects\\cms.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, __vue_template__)
...
if (false) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "C:\\Users\\Aaron\\Desktop\\portfolio github\\portfolio\\public\\assets\\views\\projects\\dsd.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, __vue_template__)
...
if (false) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "C:\\Users\\Aaron\\Desktop\\portfolio github\\portfolio\\public\\assets\\views\\projects\\elcees.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, __vue_template__)
...
if (false) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "C:\\Users\\Aaron\\Desktop\\portfolio github\\portfolio\\public\\assets\\views\\projects\\jordan.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, __vue_template__)
...
if (false) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "C:\\Users\\Aaron\\Desktop\\portfolio github\\portfolio\\public\\assets\\views\\projects\\responsiveness.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, __vue_template__)
...
var _bearandmeerkat = __webpack_require__(7);

var _bearandmeerkat2 = _interopRequireDefault(_bearandmeerkat);

var _marine = __webpack_require__(6);

var _marine2 = _interopRequireDefault(_marine);

var _elcees = __webpack_require__(10);

var _elcees2 = _interopRequireDefault(_elcees);

var _responsiveness = __webpack_require__(12);

var _responsiveness2 = _interopRequireDefault(_responsiveness);

var _jordan = __webpack_require__(11);

var _jordan2 = _interopRequireDefault(_jordan);

var _dsd = __webpack_require__(9);

var _dsd2 = _interopRequireDefault(_dsd);

var _cms = __webpack_require__(8);
...
var router = new _vueRouter2.default({
    routes: [{ path: '/', component: _Home2.default }, { path: '/about', component: _About2.default }, { path: '/projects', component: _Project2.default }, { path: '/contact', component: _Contact2.default },

    // Child views for Projects. I was going to use children[] but with the current structure it doesn't make much sense.

    { path: '/projects/bearandmeerkat', component: _bearandmeerkat2.default }, { path: '/projects/360marine', component: _marine2.default }, { path: '/projects/elcees', component: _elcees2.default }, { path: '/projects/responsiveness', component: _responsiveness2.default }, { path: '/projects/jordan', component: _jordan2.default }, { path: '/projects/dsd', component: _dsd2.default }, { path: '/projects/cms', component: _cms2.default }]
});
...
//                         <h2>About me</h2>
//                         <p>
//                             My name is Aaron, I am a Software Developer from Glasgow, Scotland who loves to develop websites.<br />
//                             I recently graduated with a First Class degree in BSc Hons Web and Mobile Development.<br />
//                         </p>
//
//                         <p>
//                             I have been developing websites for around 5 years in many languages; my favourites being JavaScript & PHP.<br />
//                             I also really like some frameworks and environments such as NodeJS, VueJS, AngularJS and Laravel. 
//                         </p>
//
//                         <p>
//                             I have a huge passion for Open Source Software. I enjoy writting software that others may find useful and love helping others learn how to program. <br />
//                             I write a lot of software in my free time and try to upload them to my GitHub. I have a backlog of software I am uploading so make sure to <a href="https://github.com/aarogrammer/">follow me on Github</a> to stay updated!
//                         </p>
//
//                         <p>    
//                             In my free time I like to play &amp; watch rugby, cycle, listen &amp; play music and travel.
//                         </p>
//
//                     </div>
//                 </div>
...
//             <div class="container">
//                 <div class="row">
//                     <div class="myportfolio col-md-5 col-sm-5">
//                     <h3>My portfolio</h3>
//                         <p>Thank you for visiting my portfolio! I am always updating this website with new projects and fixing the website itself.
//                         <br />If you have any problems or want to do work with me, please do not hesitate to <a href="#contact">contact me</a>!
//                         </p>
//                     </div>
...
//                         <ul>
//                         <li><a href="mailto:contact@aaron-welsh.co.uk">contact@aaron-welsh.co.uk</a></li>
//                         </ul>
//                        <div class="socialIcons">
//                             <a href="https://uk.linkedin.com/pub/aaron-welsh/8b/2a1/656"><span class="ion-social-linkedin"></span></a>
//                             <a href="https://plus.google.com/+AaronWelsh/"><span class="ion-social-googleplus"></span></a>
//                             <a href="https://github.com/aarogrammer/"><span class="ion-social-github"></span></a>
//                             <a href="https://twitter.com/_aaronwelsh"><span class="ion-social-twitter"></span></a>
//             			    </div>
//                     </div>
//                 </div>
//             </div>
...
//                 <div class="row">
//                     <div class="col-lg-12">
//                         Copyright &copy; Aaron Welsh 2013 - 2017
//                     </div>
//                 </div>
//             </div>
//         </div>
...
//             <div class="row">
//                 <div class="col-md-12">
//                     <h1>So you're looking for a freelance Web Developer?</h1>
//                     <p>Phew! You're in the right place!</p>
//                 </div>
//             </div>
//         </div>
...
//                         </router-link>                        
//                     </div>
//                     <div class="ccol-xs-12 col-sm-12 col-md-10 col-md-offset-1">
//                         <div class="col-md-6">
//                             <h2>360 Marine</h2>
//                             <p>
//                                 Work: Web Development <br />
//                                 <a href="https://aaron-welsh.co.uk/demos/360marine" target="_blank">Demo</a> <br />
//                                 Languages/Frameworks: jQuery, Bootstrap 3.x
//                             </p>
//                         </div>
//                         <div class="col-md-6">                        
//                             <img src="https://aaron-welsh.co.uk/public/assets/img/360marine.png"  class="img-responsive" alt="360 Marine" />
//                         </div>
//
//                         <div class="col-md-12 copy-content">
//                            <h3>Development</h3>
//                              <p>
//                                Callum approached me with the goal of having a fresh, clean website to compete in the Marine industry. It was obvious after a little bit of research that none of his competitors had much of a web presence and that their websites were very outdated. This gives 360Marine a chance to stand out.
//                                <br />
//                                Callum and I met a few times to discuss how he wants his company to be presented online, how we can define his brand to make a large impact, and overall how to get potential business from his website.
//                                <br />
//                                The solution was to create a fun, friendly website that was easy to look at and didn’t feel like a task to find out information. With it being an information based website, we found it would make most sense to have a one page website, that is broken in sections, and allows for the potential client to get in contact.
//                             </p>
//                             <h3>Conclusion</h3>
//                             <p>
//                               It was great hearing Callum's story on why he started 360Marine and to help a business with a bright-future take its first steps online.<br />
//                               The design of the website was fun to create, having photography done to add more character to the design.
//                             </p>
//                         </div>
//                     </div>
//                 </div>
...
//                     <div class="ccol-xs-12 col-sm-12 col-md-10 col-md-offset-1">
//                         <div class="col-md-6">
//                             <h2>The Bear &amp; The Meerkat</h2>
//                             <p>
//                                 Work: Web Development <br />
//                                 <a href="http://thebearandthemeerkat.co.uk" target="_blank">Demo</a> <br />
//                                 Languages/Frameworks: AngularJS, Bootstrap 3.x
//                             </p>
//                         </div>
//                         <div class="col-md-6">                        
//                             <img src="https://aaron-welsh.co.uk/public/assets/img/bandm.png"  class="img-responsive" alt="The Bear &amp; The Meerkat" />
//                         </div>
//
//                         <div class="col-md-12 copy-content">
//
//                             <h3>Notice</h3>
//                             <p>
//                                 This project is for a start up that myself, and friends who have a passion for the creative industry started up over the summer.<br />
//                                 With three of our team members finishing their final year at University, The Bear & The Meerkat is currently a freelance collaboration.<br />
//                                 If you're interested in working with The Bear & The Meerkat, contact <a href="mailto:hello@thebearandthemeerkat.co.uk">hello@thebearandthemeerkat.co.uk</a> for more information.
//                             </p>
//                             <h3>Development</h3>
//                             <p>
//                                 For this project I decided to go a bit more adventurous and use an exciting technology - AngularJS, and some Angular modules such as ui-router, to set up routing and ngAnimate to animate views (pages) to dynamically come in, rather than having to wait for the page to load.
//                                 <br />
//                                 I have used AngularJS before when developing applications when using the MEAN stack, but that was simply for creating RESTful API’s and some data binding. The use of AngularJS this time around was all about user experience.
//                                 <br />
//                                 When a user clicks on a link to load a new page, I slide the page into their view, rather than having them wait around for a page to load. All pages are pretty small in file size so they load almost instantly, giving a fun, book-like website to look through.
//                                 <br />
//                                 The design was created using Bootstrap, a front-end framework for creating fully responsive web applications. This allows for a quicker turn around as I can use Bootstrap elements, such as the container and columns, to have everything grouped together so that they respond well together. Of course a lot of CSS on my end had to be done, Bootstrap made it much easier to develop.
//                             </p>
//                             <h3>Conclusion</h3>
//                             <p>
//                                 A fun, yet challenging project having a chance to work with amazing technologies like AngularJS, and being able to work concurrently with designers to build graphics and a brand.
//                             </p>
//                         </div>
//                     </div>
//                 </div>
...
//                     <div class="ccol-xs-12 col-sm-12 col-md-10 col-md-offset-1">
//                         <div class="col-md-6">
//                             <h2>Custom Control Management System</h2>
//                             <p>
//                                 <strong>Demo is currently down due to server change. Will be back up soon!</strong><br />
//                                 Languages/Frameworks: PHP5 (OOP) with PDO extention for database connections, MySQL, JavaScript, jQuery, HTML5, CSS3
//                             </p>
//                         </div>
//                         <div class="col-md-6">                        
...
//                            <h3>Development</h3>
//                              <p>
//                                The CMS was mainly developed in PHP using the PHP Data Objects (PDO) extension for the database connection and built with OOP. This allowed for a lightweight, secure method with communicating with MySQL. <br />
//                                Any query made to or from the database is sanitised to ensure that no input, even by the admin, can damage the database.
//                             </p>
//                             <br />
//                             <h4>Some features</h4>
//                             <dl>
//                                <dt>Simple install</dt>
//                                <dd>- Simply type what database you want to use and the installation will install the tables!</dd>
//                                <dt>Register & Login system</dt>
//                                <dd>- Register your admin account and log in! If you forget to delete the install folder, we will keep a reminder until it's gone.</dd>
//                                <dt>Edit websites content</dt>
//                                <dd>- All sections on your website can be edited</dd>
//                                <dt>Create blog posts post</dt>
//                                <dd>- Create blog posts from your control panel.</dd>
//                                <dd>- Edit and delete posts</dd>
//                                <dd>- Create pretty, SEO friendly URLs to whatever you want it to be called</dd>
//                                <dt>BBCode Editor</dt>
//                                <dd>- An easy-to-use text editor that uses BBCode to simply and securely add content to your website and database</dd>
//                                <dd>- Add images, headers, links, different font size and colour, alignment and much more to your content/posts</dd>
//                                <dt>Additional SEO options</dt>
//                                <dd>- Improve your search engine ranking by editing your page's description and keywords</dd>
//                                <dt>Search for posts</dt>
//                                <dd>- Simply search for posts</dd>
//                             </dl>
//                             <h3>Conclusion</h3>
//                             <p>
//                               This project pushed me to ensure all connections with the database are secure and sanitised. I learned some new methods when using PDO and overall gained much more experience in PHP.
//                             </p>
//                             <p>Although I am happy with the back-end, in future updates I will make the font-end look much nicer. At the moment is was a quick Bootstrap design.</p>
//                         </div>
//                     </div>
//                 </div>
//             </div>
...
//                             <p>
//                                 Work: Web Development <br />
//                                 <a href="http://dsd-scotland.co.uk/" target="_blank">Demo</a> <br />
//                                 Languages/Frameworks: WordPress (CMS), PHP, SQL, JavaScript
//                             </p>
//                         </div>
//                         <div class="col-md-6">                        
//                             <img src="https://aaron-welsh.co.uk/public/assets/img/dsd.png"  class="img-responsive" alt="DSD" />
//                         </div>
//
//                         <div class="col-md-12 copy-content">
//                            <h3>Development</h3>
//                              <p>
//                                 Being in college and having a huge passion for Web Development - knowing this is what I wanted to do career wise - I decided to get the experience by taking on clients.
//                                 When I was approached by DSD Scotland, I was excited to start my freelance Web Development journey.<br />
//                                 Keith, who was head of security, approached me with an idea of what he was after, and already had a theme that he had purchased and wanted me to edit it to fit the style of DSD Scotland.
//                                 When I started working on this theme, I noticed that it was full of bugs. I brought these issues up to Keith, and we sat down and drew up new ideas.<br />
//                                 I was then hired to completely redevelop their website, taking as much information as possible on how they would want it to look.
//                             </p>
//                             <h3>Communication</h3>
//                              <p>
//                                With having to start this project from nothing, communication was very important with understanding what DSD wanted for their website.
//                                Keith was very vocal from the start on what he had visioned for the website, giving me ideas and examples of what he thinks would be good for the website.<br />
//                                Keith and I kept great communication throughout the project exchanging several emails and meeting up in person regularly
//                             </p>
//                             <h3>Testimonial</h3>
//                             <p class="testimonial breadcrumb">
//                               I contacted Aaron to build our company website with just a few ideas in mind, a limited budget and a view to maintain the site ourselves as the company expanded.<br />
//
//                               Aaron provided an onsite consultation and walked us through what the possibilities were given the budget and requirements from this primarily service based website.<br />
//
//                               After viewing some draft copies of the website and some minor changes we had a final consultation to add the required content and check functionality. The end result is a website which provides a slick and easy to use informational site with all of the required functionality and content.<br />
//
//                               Communications were excellent throughout the whole process and Aaron went out of his way to ensure he met our expectations. DSD Scotland Ltd would be happy to recommend Aaron to any prospective customers.<br />
//
//                               Keith Yuill<br />
...
//                             <h3>Conclusion</h3>
//                             <p>
//                               This was a fantastic first-paid client project - having its ups and downs with progress due to their theme being buggy.<br />
//                               This helped me learn how to communicate with clients in the real world and how to act professional.
//                             </p>
//                         </div>
//                     </div>
//                 </div>
...
//                             <p>
//                                 Work: Web Development <br />
//                                 <a href="https://aaron-welsh.co.uk/demos/elcees" target="_blank">Demo</a> <br />
//                                 Languages/Frameworks: jQuery, Bootstrap 3.x
//                             </p>
//                         </div>
//                         <div class="col-md-6">                        
//                             <img src="https://aaron-welsh.co.uk/public/assets/img/elc.png"  class="img-responsive" alt="Elcees" />
//                         </div>
//
//                         <div class="col-md-12 copy-content">
//                            <h3>Development</h3>
//                              <p>
//                               With Elcee's being a completely brand new salon and of course not having a previous website, I was completely free to design and develop this website from scatch.<br />
//                               I met up with Elcee's owner, Leeanne to discuss what kind of website she would like, and about the overall design of the website. Meeting at her salon was a great way to understand
//                               what Elcee's is, and have a general feel of the salon.<br />
//                               I designed the website to look similar to the design of the salon, using similar fonts and colours to achieve the final product
//                             </p>
//                             <h3>Communication</h3>
//                              <p>
//                                Communication was always maintained throughout the project with regular meetings and messages exchanged. I was always updating Leeanne with any ideas I had, and asking for her opinion.
//                             </p>
//                             <h3>Testimonial</h3>
//                             <p class="testimonial breadcrumb">
//                                 Aaron Welsh produced a brilliant website for my salon. The colour scheme went well with the black and white theme in the salon. We wanted it to be modern, clean and not have too much going on.<br /> 
//                                 A lot of salon websites can be too cluttered and a bit of an eye sore and that's what we wanted to avoid.  Aaron was professional and informative. I would definitely recommend his services. <br />
//                                 -Leeanne Callaghan. El CEE'S Hair and Beauty.
//                             </p>
//
//                             <h3>Conclusion</h3>
//                             <p>
//                               This was great experience dealing with a client/company that has had no web presence before, allowing me to help build that from grond up.
//                             </p>
//                         </div>
//                     </div>
//                 </div>
...
//                             <p>
//                                 Work: Web Development <br />
//                                 <a href="https://aaron-welsh.co.uk/demos/jordan" target="_blank">Demo</a> <br />
//                                 Languages/Frameworks: jQuery, Bootstrap 3.x
//                             </p>
//                         </div>
//                         <div class="col-md-6">                        
...
//                             <h3>Communication</h3>
//                              <p>
//                                Jordan and I kept great contact via Skype, regularly sending messages back and forth, exchanging ideas and making sure I got each part correct. <br />
//                             </p>
//                             <h3>Conclusion</h3>
//                             <p>
//                               It was a great experience looking at an idea from an image and making that in to code. I feel that the website totally replicated what Jordan required from his draft and I was happy with the final product.
//                             </p>
//                         </div>
//                     </div>
//                 </div>
...
//                             <p>
//                                 <a href="https://github.com/aarogrammer/responsiveness" target="_blank">Code</a> <br />
//                                 <a href="https://aaron-welsh.co.uk/demos/responsiveness" target="_blank">Demo</a> <br />
//                                 Languages/Frameworks: JavaScript, Bootstrap 3.x
//                             </p>
//                         </div>
//                         <div class="col-md-6">                        
//                             <img src="https://aaron-welsh.co.uk/public/assets/img/phone.png"  class="img-responsive" alt="Responsiveness" />
//                         </div>
//
//                         <div class="col-md-12 copy-content">
//                            <h3>Development</h3>
//                              <p>
//                                This project was mainly developed in JavaScript. The project idea was simple - load a website using an iFrame and then manipulate it using JavaScript.</p>
//                                <p>The main goal was to keep the project scalable so that future development can be done by others. The projects code is developed using JavaScript's prototype object to simplify and make the code easy to modify and understand.
//                             </p>
//                             <p>All the source code can be found on <a href="https://github.com/aarogrammer/responsiveness">Github</a> and can can easily be forked!</p>
//                             <h3>Conclusion</h3>
//                             <p>
//                               Overall this tool is very useful in easily testing the websites design on specific resolutions.
//                               It can be very tedious having to resize your browser to test how your website responds and this tool allows you to simply enter the URL and then choose whatever sizes you want.
//                             </p>
//                             <p>I am happy with the starting point of this project and feel that developers could easily download the source code and make it even better.</p>
//                         </div>
//                     </div>
//                 </div>
//             </div>
...
if (false) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "C:\\Users\\Aaron\\Desktop\\portfolio github\\portfolio\\public\\assets\\views\\Footer.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, __vue_template__)
...
if (false) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "C:\\Users\\Aaron\\Desktop\\portfolio github\\portfolio\\public\\assets\\views\\Header.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, __vue_template__)
...
if (false) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "C:\\Users\\Aaron\\Desktop\\portfolio github\\portfolio\\public\\assets\\views\\Nav.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, __vue_template__)
